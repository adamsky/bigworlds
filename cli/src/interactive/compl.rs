...
use super::config::CFG_VARS;
use super::{SimDriver, APP_COMMANDS};
...
fn complete_address_local(word: &str, sim: &SimHandle) -> Vec<Completion> {
    unimplemented!();
    // let mut res = Vec::new();
    ...
    //     let w = split[4];
    //
    //     // let var_types = bigworlds::VAR_TYPES;
